...
PRINT 'Creating performance indexes (SQL Server 2014 compatible)...';
...
BEGIN
    ...
    INCLUDE ([WarehouseId], [Quantity], [ReservedQuantity]);
...
BEGIN
    ...
    INCLUDE ([ProductId], [Quantity], [ReservedQuantity]);
...
BEGIN
    ...
    INCLUDE ([ProductId], [WarehouseId], [QuantityChanged], [UnitCost]);
...
PRINT 'Database indexing completed - Performance optimized (SQL Server 2014 Compatible)!';